...
var _reveal = __webpack_require__(32);
...
var slides = requireAll(__webpack_require__(8));
slides = slides.sort(function (a, b) {
  return a.order - b.order;
});
var slide = __webpack_require__(33).slide;
var thanks = __webpack_require__(34).thankYouList;
var knownTemplates = { 'slide': slide, 'thanks': thanks };

slides.forEach(function (slideContent) {
  var dataObj = { contents: slideContent.__content };
  Object.assign(dataObj, slideContent);
  var templateName = 'slide';
  if (slideContent.template) {
    templateName = slideContent.template;
  }
  var html = knownTemplates[templateName](dataObj);
...
module.exports = {"order":2,"__content":"<h1 id=\"naming-is-hard-\">Naming is hard!</h1>\n<p><img src=\"/dist/images/naming-is-hard.jpg\" alt=\"mad baby\"></p>\n<h2 id=\"a-suggested-convention\">A suggested convention</h2>\n<p>from <a href=\"http://nicolasgallagher.com/about-html-semantics-front-end-architecture/\">Nicholas Gallagher</a> and based on <a href=\"http://getbem.com/introduction/\">BEM</a></p>\n<pre><code class=\"lang-scss\">// corresponding files\n// sass/modules/ComponentName.scss\n// js/modules/ComponentName.js\n// templates/modules/ComponentName.soy\n\n/* Component/Module */\n.ComponentName {}\n\n/* Component/Module with modifier */\n.ComponentName--modifierName {}\n\n/* Component descendant */\n.ComponentName-descendant {}\n\n/* Component descendant modifier */\n.ComponentName-descendant--modifier {}\n\n/* Component state (scoped to component) */\n.ComponentName.is-stateOfComponent {}\n</code></pre>\n<h2 id=\"but-why-\">But why?</h2>\n<ul>\n<li>Easily know from the inspector, where to go for <em>all the things</em></li>\n<li>Clear separation between the Module and the children</li>\n<li>Naming mostly independent of HTML structure</li>\n<li>Modules/Components are never dependent on other elements on a page, so you will never experience cascade problems</li>\n<li>Easy to understand what&#39;s going on</li>\n<li>Compose-ability</li>\n</ul>\n<h2 id=\"examples-\">Examples!</h2>\n<h2 id=\"extension-using-aria-for-state\">Extension -- using ARIA for State</h2>\n<p>Bootstrap Collapse vs ARIA Collapse</p>\n<h3 id=\"bootstrap-\">Bootstrap:</h3>\n<pre><code class=\"lang-css\"> .expanded {display: inline;}\n .closed {display: none; }\n .collapsed .expanded { display: none;}\n .collapsed .closed { display: inline; }\n .collapse { display: none; }\n</code></pre>\n<pre><code class=\"lang-html\">&lt;button class=&quot;btn collapsed&quot; data-toggle=&quot;collapse&quot; data-target=&quot;#target&quot;&gt;\n  &lt;span class=&quot;expanded&quot;&gt;Close me&lt;/span&gt;\n  &lt;span class=&quot;closed&quot;&gt;Open Me&lt;/span&gt;\n&lt;/button&gt;\n&lt;p class=&quot;collapse&quot; id=&quot;target&quot;&gt;\n  content\n&lt;/p&gt;\n</code></pre>\n<pre><code class=\"lang-js\">for (let collapser of document.querySelectorAll(&#39;[data-toggle=&quot;collapse&quot;]&#39;)) {\n  collapser.addEventListener( () =&gt; {\n    document.querySelector(collapser.dataset.target).classList.toggle(&#39;collapse&#39;);\n  });\n}\n</code></pre>\n<h3 id=\"aria\">Aria</h3>\n<pre><code class=\"lang-css\">[aria-hidden=&quot;true&quot;] {display: none;}\n</code></pre>\n<pre><code class=\"lang-html\">&lt;button class=&quot;Collapser&quot; aria-expanded=&quot;false&quot; aria-controls=&quot;target-aria&quot; aria-live=&quot;polite&quot;&gt;\n   ARIA\n  &lt;span class=&quot;Collapser-toggleOpen&quot;\n        aria-hidden=&quot;true&quot;&gt;\n    Close Me\n  &lt;/span&gt;\n  &lt;span class=&quot;Collapser-toggleClosed&quot;\n        aria-hidden=&quot;false&quot;&gt;\n    Open Me\n  &lt;/span&gt;\n&lt;/button&gt;\n&lt;p class=&quot;Collapser-target&quot;\n   id=&quot;target-aria&quot;\n   aria-hidden=&quot;true&quot;&gt;\n  aria content\n&lt;/p&gt;\n</code></pre>\n<pre><code class=\"lang-js\">for (let collapser of document.querySelectorAll(&#39;.Collapser&#39;)) {\n  const target = document.getElementById(collapser.getAttribute(&#39;aria-controls&#39;));\n  const toggleOpen = collapser.querySelector(&#39;.Collapser-toggleOpen&#39;);\n  const toggleClosed = collapser.querySelector(&#39;.Collapser-toggleClosed&#39;);\n  collapser.addEventListener(&#39;click&#39;, () =&gt;{\n    const nowIsExpanded = !(collapser.getAttribute(&#39;aria-expanded&#39;) === &#39;true&#39;);\n    collapser.setAttribute(&#39;aria-expanded&#39;, nowIsExpanded);    \n    target.setAttribute(&#39;aria-hidden&#39;, !nowIsExpanded);\n    toggleOpen.setAttribute(&#39;aria-hidden&#39;, !nowIsExpanded);\n    toggleClosed.setAttribute(&#39;aria-hidden&#39;, nowIsExpanded);\n  });\n}\n</code></pre>\n<p>Needs more thought/research.</p>\n"}

/***/ }),
/* 26 */
/***/ (function(module, exports) {

module.exports = {"order":1,"__content":"<p><em>The following is stolen liberally from <a href=\"https://medium.com/objects-in-space/objects-in-space-f6f404727\">https://medium.com/objects-in-space/objects-in-space-f6f404727</a></em></p>\n<h1 id=\"user-needs-beer\">User Needs Beer</h1>\n<pre><code class=\"lang-scss\">// module/Beer.scss\n.Beer {\n  color:amber;\n  display:liquid;\n  alcohol:5.2%;\n}\n</code></pre>\n<p><img src=\"http://blogs.wickedlocal.com/beernut/files/2011/06/IMG00173-20110604-1341-424x318.jpg\" alt=\"Photo of a puddle of beer\"></p>\n<p>🤔 it&#39;s all over the floor! What&#39;s going on?</p>\n<blockquote>\n<p>beer’s properties should not depend on its presentation method</p>\n</blockquote>\n<p><em>Presenting Beer</em></p>\n<p>![Photo of bartender with beer]</p>\n<pre><code class=\"lang-scss\">// module/Cup.scss\n.Cup {\n  border-radius: 100%;\n}\n</code></pre>\n<p>🤔 this doesn&#39;t hold much beer...</p>\n<p>💡 we need a more specific cup</p>\n<pre><code class=\"lang-scss\">// module/Cup.scss\n.Cup--glass {\n  @extend .Cup;\n  border-color: transparent;\n  opacity: .5;\n}\n\n.Cup--pintGlass {\n  @extend .Cup--glass;\n  height: 1pint;\n}\n</code></pre>\n<p><em>Debate: Who should know about how the beer looks in a pint glass? The beer or the pint glass?</em></p>\n<p><em>Should the cup?</em></p>\n<pre><code class=\"lang-scss\">// module/Cup.scss\n.Cup--glass {\n  @extend .Cup;\n  border-color: transparent;\n  opacity: .5;\n}\n\n.Cup--pintGlass {\n  @extend .Cup--glass;\n  height: 1pint;\n}\n\n// it does this whenever it&#39;s put inside ANY cup\n.Cup-beer {\n  height: 85%;\n  head: 10%;\n}\n</code></pre>\n<pre><code class=\"lang-html\">&lt;div class=&quot;Cup--pintGlass&quot;&gt;\n  &lt;div class=&quot;Beer Cup-beer&quot;&gt;\n    ...Dogfish Head 60 Minute...\n  &lt;/div&gt;\n&lt;/div&gt;\n</code></pre>\n<p><em>or the beer?</em></p>\n<pre><code class=\"lang-scss\">// module/Beer.scss\n.Beer {\n  color: amber;  \n  display:liquid;\n  alcohol:5.2%;\n\n  .Cup &amp; {\n    height: 85%;\n    head: 10%;\n  }\n}\n</code></pre>\n<pre><code class=\"lang-html\">&lt;div class=&quot;Cup Cup--pintGlass&quot;&gt;\n  &lt;div class=&quot;Beer&quot;&gt;\n    ...Dogfish Head 60 Minute...\n  &lt;/div&gt;\n&lt;/div&gt;\n</code></pre>\n<p><em>Debate: Multi-class or single class?</em></p>\n<pre><code class=\"lang-html\">&lt;div class=&quot;Cup Cup-pintGlass&quot;&gt;&lt;/div&gt;\n/* vs */\n&lt;div class=&quot;Cup-pintGlass&quot;&gt;&lt;/div&gt;\n</code></pre>\n<p><em>States</em></p>\n<pre><code class=\"lang-scss\">// state/state.scss\n.is-poisoned {\n  font-family: &#39;Comic Sans&#39;, sans-serif;\n  font-size: 4em;\n  color: puse;\n}\n</code></pre>\n<pre><code class=\"lang-html\">&lt;div class=&quot;Beer is-poisoned&quot;&gt;\n&lt;/div&gt;\n\n&lt;div class=&#39;Food is-poisoned&#39;&gt;\n&lt;/div&gt;\n\n&lt;div class=&quot;PoisonousPotionOfPoisoning is-poisoned&quot;&gt;\n&lt;/div&gt;\n</code></pre>\n<p><em>Module specific states</em></p>\n<pre><code class=\"lang-scss\">// module/Beer.scss\n\n.Beer\n{\n  &amp;&amp;--is-flat // .Beer.Beer--is-flat\n  {\n    head: 0px;\n  }\n\n  &amp;&amp;--is-skunked // .Beer.Beer--is-skunked\n  {\n    taste: heineken;\n  }\n}\n</code></pre>\n<pre><code class=\"lang-html\">&lt;div class=&quot;Beer Beer--is-skunked&quot;&gt;\n  ...gross...\n&lt;/div&gt;\n</code></pre>\n<blockquote>\n<p>Break something into a module only if it would be useful in another context. Everything else remains an element or component inside a module.</p>\n</blockquote>\n"}

/***/ }),
/* 27 */
/***/ (function(module, exports) {

module.exports = {"order":0,"__content":"<p><em>The following is stolen liberally from <a href=\"http://nicolasgallagher.com/about-html-semantics-front-end-architecture/\">http://nicolasgallagher.com/about-html-semantics-front-end-architecture/</a></em></p>\n<h2 id=\"se-man-tics-\">Se•man•tics:</h2>\n<blockquote>\n<p> the study of the relationships between signs and symbols and what they represent</p>\n</blockquote>\n<h2 id=\"html-semantics\">HTML Semantics</h2>\n<ul>\n<li>This is the semantics of the content\n<strong> e.g. <code>&lt;p&gt;</code>, <code>&lt;h1&gt;</code>, and <code>&lt;section&gt;</code> tags\n</strong> or <code>role=&quot;button&quot;</code> or <code>aria-hidden=&quot;true&quot;</code></li>\n<li>It tells a <em>machine</em> what the content means, e.g. Google or JAWS</li>\n</ul>\n<h2 id=\"engineering-semantics\">Engineering Semantics</h2>\n<blockquote>\n<p>not all semantics need to be content-derived</p>\n</blockquote>\n<p>It is important that we as engineers, use application-specific semantics so that other engineers know what the f*@% is going on with our code.</p>\n<h2 id=\"an-example-from-my-past\">An example from my past</h2>\n<pre><code class=\"lang-html\">&lt;a class=&quot;promotion-button&quot;&gt;Shop now&lt;/a&gt;\n&lt;a class=&quot;cta-button cta-menu-button&quot;&gt;View Full Menu&lt;/a&gt;\n&lt;a class=&quot;cta-button cta-button-instagram&quot;&gt;Follow us on instagram&lt;/a&gt;\n</code></pre>\n<pre><code class=\"lang-css\">.button-primary,\n.cta-button,\n.cta-menu-button,\n.promotion-button {\n  background-color: #f0ede3;\n  color: #b1501e;\n  text-decoration: none;\n}\n</code></pre>\n<p><em>Why the content specific classes?</em></p>\n<p>(╯°□°）╯︵ ┻━┻</p>\n<p>Because SMACSS confused me.</p>\n<h3 id=\"gallagher-s-reasoning-\">Gallagher&#39;s Reasoning:</h3>\n<blockquote>\n<p>Content-layer semantics are already served by HTML elements.\nClass names impart little or no useful semantic information to machines.\nThe primary purpose of a class name is to be a hook for CSS and JavaScript.\nClass names should communicate <em>useful</em> information to <em>developers</em>.</p>\n</blockquote>\n<h2 id=\"class-names-are-ideally-independent-of-content\">Class names are ideally independent of content</h2>\n<blockquote>\n<p>The most reusable components are those with class names that are independent of the content.</p>\n</blockquote>\n<h2 id=\"fixing-my-past\">Fixing my past</h2>\n<pre><code class=\"lang-html\">&lt;a class=&quot;Button--cta&quot;&gt;Shop now&lt;/a&gt;\n&lt;a class=&quot;Button--cta&quot;&gt;View Full Menu&lt;/a&gt;\n&lt;a class=&quot;Button--cta&quot;&gt;Follow us on instagram&lt;/a&gt;\n</code></pre>\n<pre><code class=\"lang-css\">.Button--cta {\n  background-color: #f0ede3;\n  color: #b1501e;\n  text-decoration: none;\n}\n</code></pre>\n<h2 id=\"single-class-vs-multi-class-modifiers\">Single-Class vs Multi-class modifiers</h2>\n<p>We often have variants of different classes, especially links, headings and buttons.  </p>\n<p>Single Class Pattern:</p>\n<pre><code class=\"lang-html\">.Heading, .Heading--lead, .Heading--quiet {\n  font-family: sans-serif;\n  margin-top: .5em;\n  margin-bottom: 1em;\n  -webkit-font-smoothing: antialiased;\n}\n.Heading--lead {\n  font-size: 3rem;\n  font-weight: 300;\n}\n.Heading--quiet {\n  font-size: .8rem;\n  font-weight: 400;\n  color: light-gray;\n}\n\n&lt;h1 class=&quot;Heading--lead&quot;&gt;Welcome&lt;/h1&gt;\n&lt;h3 class=&quot;Heading--quiet&quot;&gt;About&lt;/h3&gt;\n</code></pre>\n<p>Multi Class Pattern:</p>\n<pre><code class=\"lang-html\">.Heading {\n  font-family: sans-serif;\n  margin-top: .5em;\n  margin-bottom: 1em;\n  -webkit-font-smoothing: antialiased;\n}\n.Heading--lead {\n  font-size: 3rem;\n  font-weight: 300;\n}\n.Heading--quiet {\n  font-size: .8rem;\n  font-weight: 400;\n  color: light-gray;\n}\n\n&lt;h1 class=&quot;Heading Heading--lead&quot;&gt;Welcome&lt;/h1&gt;\n&lt;h3 class=&quot;Heading Heading--quiet&quot;&gt;About&lt;/h3&gt;\n</code></pre>\n<p><em>Q: which do you prefer?</em></p>\n"}

/***/ }),
/* 28 */
/***/ (function(module, exports) {

module.exports = {"order":99,"template":"thanks","list":[{"author":"Nicolas Gallagher","link":"http://nicolasgallagher.com/about-html-semantics-front-end-architecture/","article":"About HTML Semantics and Front End Architecture"},{"author":"Andrew Colclough","link":"https://medium.com/objects-in-space/objects-in-space-f6f404727","article":"Objects in Space"},{"author":"Chris Coyier","link":"https://css-tricks.com/opt-in-typography/","article":"Opt-in Typography"},{"author":"Micah Godbolt","link":"https://www.phase2technology.com/blog/used-and-abused-css-inheritance-and-our-misuse-of-the-cascade/","article":"Used and Abused – CSS Inheritance and Our Misuse of the Cascade"},{"author":"Nicole Sullivan","link":"http://www.stubbornella.org/content/2010/06/25/the-media-object-saves-hundreds-of-lines-of-code/","article":"The Media Object Saves Hundreds of Lines of Code"},{"author":"Harry Roberts","link":"https://csswizardry.com/2013/01/mindbemding-getting-your-head-round-bem-syntax/","article":"MindBEMing—getting your head ‘round BEM syntax"},{"author":"Ben Frain","link":"http://ecss.io/chapter6.html","article":"ECSS Chapter 6. Dealing with State"}],"__content":"<h2 id=\"thank-you\">Thank you</h2>\n<p>  This presentation would not be possible without the thought leadership of:</p>\n"}
...
var goog = __webpack_require__(31).goog;
var soy = __webpack_require__(31).soy;
var soydata = __webpack_require__(31).soydata;
var soyshim = __webpack_require__(31).soyshim;
var preso;
...
preso.thankYouList = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<section class="ThankYous"><section class="ThankYou-intro">' + soy.$$filterNoAutoescape(opt_data.contents) + '</section>';
